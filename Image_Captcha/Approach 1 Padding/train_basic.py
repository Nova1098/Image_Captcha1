# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 17:53:06 2023

"""

###########################################################
## ReadME                  ################################
## Make changes in the call_this call last line          ##
###########################################################
...
def modify_random_image_label(input_string, captcha_length):
    ...
    if len(input_string) < captcha_length:
        ...
        modified_string = modified_string.ljust(7, "£")
    else:
    ...
    def __getitem__(self, idx):
        ...
        for i in range(self.batch_size):
            if self.files.keys():
                ...
                if os.path.exists(os.path.join(self.directory_name, random_image_file)):
                    ...
                    random_image_label = random_image_label.rsplit("_", 1)[0]
...
callthis("symbols.txt", 32, 128, 64, 7, 50, "model1", None, "/users/pgrad/singhr6/Desktop/ProcessedTrainImage2", "/users/pgrad/singhr6/Desktop/ProcessedValidateImage2")    # Make changes here as per directory structure
